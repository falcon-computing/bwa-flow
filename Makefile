...
PP=			g++
#CC=			clang --analyze
CFLAGS=		-g -Wall -Wno-unused-function -O2 -pg 
WRAP_MALLOC=-DUSE_MALLOC_WRAPPERS
AR=			ar
DFLAGS=		-DHAVE_PTHREAD $(WRAP_MALLOC)
OBJ_DIR=	./bwa/
LOBJS_OLD=		utils.o kthread.o kstring.o ksw.o bwt.o bntseq.o bwa.o bwamem.o bwamem_pair.o bwamem_extra.o malloc_wrap.o \
			QSufSort.o bwt_gen.o rope.o rle.o is.o bwtindex.o
AOBJS_OLD=		bwashm.o bwase.o bwaseqio.o bwtgap.o bwtaln.o bamlite.o \
			bwape.o kopen.o pemerge.o maxk.o \
			bwtsw2_core.o bwtsw2_main.o bwtsw2_aux.o bwt_lite.o \
			bwtsw2_chain.o fastmap.o bwtsw2_pair.o

LOBJS=$(addprefix $(OBJ_DIR),$(LOBJS_OLD))
AOBJS=$(addprefix $(OBJ_DIR),$(AOBJS_OLD))
WOBJS= 			./src/wrappered_mem.o ./src/preprocess.o
...
.cpp.o:
		$(PP) -c $(CFLAGS) $(DFLAGS) $(INCLUDES) $< -o $@


all:$(PROG)

./bin/bwa:libbwa.a $(AOBJS) ./src/main.o $(WOBJS) 
		$(PP) $(CFLAGS) $(DFLAGS) $(AOBJS) $(WOBJS) $(INCLUDES) ./src/main.o -o $@ -L. -lbwa $(LIBS)
...
clean:
		rm -f gmon.out *.o a.out $(PROG) *~ *.a ./bwa/*.o ./bwa/gmon.out ./bwa/a.out ./src/*.o 
